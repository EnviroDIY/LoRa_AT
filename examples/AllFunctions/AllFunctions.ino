 ...
 * Tests enabled
 */
#define TINY_LORA_TEST_GPRS true
#define TINY_LORA_TEST_WIFI false
#define TINY_LORA_TEST_TCP true
#define TINY_LORA_TEST_SSL true
#define TINY_LORA_TEST_CALL false
#define TINY_LORA_TEST_SMS false
#define TINY_LORA_TEST_USSD false
#define TINY_LORA_TEST_BATTERY true
#define TINY_LORA_TEST_TEMPERATURE true
#define TINY_LORA_TEST_GSM_LOCATION false
#define TINY_LORA_TEST_NTP false
#define TINY_LORA_TEST_TIME false
#define TINY_LORA_TEST_GPS false
...
#if TINY_LORA_TEST_GPRS && not defined TINY_LORA_HAS_GPRS
#undef TINY_LORA_TEST_GPRS
#undef TINY_LORA_TEST_WIFI
#define TINY_LORA_TEST_GPRS false
#define TINY_LORA_TEST_WIFI true
#endif
#if TINY_LORA_TEST_WIFI && not defined TINY_LORA_HAS_WIFI
...
#if TINY_LORA_TEST_GPRS
  // Unlock your SIM card with a PIN if needed
  if (GSM_PIN && modem.getSimStatus() != 3) { modem.simUnlock(GSM_PIN); }
#endif

#if TINY_LORA_TEST_WIFI
...
#if TINY_LORA_TEST_GPRS && defined TINY_LORA_XBEE
...
#if TINY_LORA_TEST_USSD && defined TINY_LORA_HAS_SMS
...
#if TINY_LORA_TEST_TCP && defined TINY_LORA_HAS_TCP
  TinyLoRaClient client(modem, 0);
  const int      port = 80;
...
#if TINY_LORA_TEST_SSL && defined TINY_LORA_HAS_SSL
  TinyLoRaClientSecure secureClient(modem, 1);
...
#if TINY_LORA_TEST_CALL && defined TINY_LORA_HAS_CALLING && defined CALL_TARGET
...
#if TINY_LORA_TEST_SMS && defined TINY_LORA_HAS_SMS && defined SMS_TARGET
...
#if TINY_LORA_TEST_GSM_LOCATION && defined TINY_LORA_HAS_GSM_LOCATION
  float lat      = 0;
  float lon      = 0;
  float accuracy = 0;
  int   year     = 0;
...
#if TINY_LORA_TEST_GPS && defined TINY_LORA_HAS_GPS
...
#if TINY_LORA_TEST_NTP && defined TINY_LORA_HAS_NTP
